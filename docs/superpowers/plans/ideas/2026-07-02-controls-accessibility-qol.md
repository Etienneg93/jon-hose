...
> **STATUS: §1 SHIPPED** (input buffer + neutral dash, main 958a499; player-enemy body collision removed as follow-up). Settings panel, remap, colorblind patterns, dead-code deletion still open.
